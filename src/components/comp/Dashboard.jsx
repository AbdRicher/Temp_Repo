...
const Dashboard = () => {
    ...
    const current_budget = userHistory.budget
    const current_expenses = userHistory.expenses
    const current_investments = userHistory.investments
    const current_goals = userHistory.goals

    console.log("Current Budget: ", current_budget)
    console.log("Current Budget Amount: ", current_budget.reduce((sum, budget) => sum + budget.amount, 0))
    console.log("Current expenses: ", current_expenses)
    console.log("Current expenses Amount: ", current_expenses.reduce((sum, budget) => sum + budget.amount, 0))
    console.log("Current investment: ", current_investments)
    console.log("Current investment Amount: ", current_investments.reduce((sum, budget) => sum + budget.amount, 0))
    console.log("Current Goals: ", current_goals)
    console.log("Current Goals Amount: ", current_goals.reduce((sum, budget) => sum + budget.amount, 0))
    ...
    return (
        <div className="dashboard-container">
            ...
            <nav className={`side-bar ${isExpanded ? "expanded" : ""}`}>
                ...
                <ul className="menu"> 
                    <li className="menu-item" title="Dashboard" onClick={() => navigate("/dashboard")}> 
            ...
            <div className={`main-content ${isExpanded ? "shifted" : ""}`}>
                ...
                <div className="cards-container">
                    <div className="card balance-card" onClick={() => navigate("/budget")}>
